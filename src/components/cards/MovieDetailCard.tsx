  ...
  return (
    <div className="bg-[#394B61] h-full flex flex-row rounded-[11px] overflow-hidden">
      ...
      <div className="animated-card-right-content flex-1 p-3.5 sm:p-6 xl:pl-11 xl:pr-11 xl:pt-8 xl:pb-6 space-y-3 xl:space-y-6">
        <h2 className="text-[#D4D7DD] text-base lg:text-3xl font-bold">
          {title}
        </h2>

        <div className="flex items-center gap-3">
          <div
            className={`w-28 bg-[#283647] rounded-full h-2 ${
              rating === "N/A" ? " bg-[#283647]/50" : ""
            }`}
          >
            <div
              style={{
          ...
          <span className="text-white text-xs lg:text-base font-semibold">
            {parseFloat(rating) || 0}/10
          </span>
        </div>
        ...
        <div className="space-y-3 lg:space-y-4">
          <ul className="max-w-[168px] sm:max-w-lg flex flex-col text-[#D4D7DD] text-xs lg:text-base font-semibold whitespace-nowrap space-y-1">
            <li className="inline-flex items-center">
              <span className="min-w-[92px] lg:min-w-[140px] inline-block">
                Year:
              </span>
          ...
          <p className="line-clamp-2 font-normal text-xs lg:text-sm leading-[18px] text-white">
            {plot}
          </p>
