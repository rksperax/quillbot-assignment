...
export const MovieCard: FC<MovieCardProps> = ({ title, poster, onClick }: MovieCardProps) => {
  return (
    <div
    ...
    >
      ...
      <ul className="flex items-center gap-4">
        <li>
          <IconPlay className="w-5 h-5 text-[#D4D7DD]" />
        </li>
        <li>
          <IconPlus className="w-5 h-5 text-[#D4D7DD]" />
        </li>
      </ul>
    </div>
  );
