                ...
                <li key={index.toString()}>
                  <a
                    ...
                    className={`relative group flex items-center gap-[14px] transition-colors
                        ${
                          link.current
                            ? ' text-[#00E0FF] after:content-[""] after:absolute after:right-0 after:w-1 after:h-full after:bg-[#00E0FF]'
                            : " text-[#D4D7DD] hover:text-[#D4D7DD]/80"
                        }
                        `}
                  >
                    {link.icon && (
                      <link.icon
                        className={`${
                          link.current
                            ? "text-[#00E0FF]"
                            : "text-[#D4D7DD] group-hover:text-[#D4D7DD]/80"
