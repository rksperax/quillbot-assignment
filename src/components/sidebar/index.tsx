...
import SiderbarLinkList from "./SiderbarLinkList";

export interface SidebarProps {
  openSidebar: boolean;
  closeSidebar: () => unknown;
  userProfiles: ComponentProps<typeof UserProfile>;
}
  ...
  return (
    <>
          ...
          <div className="fixed inset-0 z-40 flex">
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-[#1F2A3C]">
                ...
                <SidebarMenuList navigationLink={SiderbarLinkList} />
              </Dialog.Panel>
            </Transition.Child>
          </div>
        </Dialog>
      ...
      <div className="hidden lg:flex min-h-0 flex-1 flex-col bg-[#1F2A3C]">
        <UserProfile avatar={userProfiles.avatar} name={userProfiles.name} />
